...
@Ignore
public class UsersUserIdPostHandlerTest {
    @ClassRule
    public static TestServer server = TestServer.getInstance();

    static final Logger logger = LoggerFactory.getLogger(UsersUserIdPostHandlerTest.class);
    ...
    @Test
    public void testUsersUserIdPostHandlerTest() throws ClientException {
